...
from models import LoRALinear, DoRALinear
...
if __name__ == "__main__":
    ...
    for l in model.model.layers[len(model.model.layers) - args.lora_layers :]:
        l.self_attn.q_proj = DoRALinear.from_linear(l.self_attn.q_proj)
        l.self_attn.v_proj = DoRALinear.from_linear(l.self_attn.v_proj)
        if hasattr(l, "block_sparse_moe"):
            l.block_sparse_moe.gate = DoRALinear.from_linear(l.block_sparse_moe.gate)
